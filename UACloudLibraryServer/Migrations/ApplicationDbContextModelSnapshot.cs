...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.Models.CategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.Models.OrganisationModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.CloudLibNodeSetModel", b =>
                {
                    b.HasBaseType("Opc.Ua.Cloud.Library.NodeSetModel");
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.Models.NamespaceMetaDataModel", b =>
                {
                    b.HasOne("Opc.Ua.Cloud.Library.Models.CategoryModel", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Opc.Ua.Cloud.Library.Models.OrganisationModel", "Contributor")
                        .WithMany()
                        .HasForeignKey("ContributorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Opc.Ua.Cloud.Library.Models.AdditionalPropertyModel", "AdditionalProperties", b1 =>
                        {
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.BaseTypeModel", b =>
                {
                    ...
                    b.HasOne("Opc.Ua.Cloud.Library.BaseTypeModel", "SuperType")
                        .WithMany("SubTypes")
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.MethodModel", b =>
                {
                    ...
                    b.HasOne("Opc.Ua.Cloud.Library.MethodModel", "TypeDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.ObjectModel", b =>
                {
                    ...
                    b.HasOne("Opc.Ua.Cloud.Library.ObjectTypeModel", "TypeDefinition")
                        .WithMany()
                        .HasForeignKey("TypeDefinitionNodeId", "TypeDefinitionNodeSetModelUri", "TypeDefinitionNodeSetPublicationDate")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Opc.Ua.Cloud.Library.VariableModel", b =>
                {
                    b.HasOne("Opc.Ua.Cloud.Library.DataTypeModel", "DataType")
                        .WithMany()
                    ...
                    b.HasOne("Opc.Ua.Cloud.Library.VariableTypeModel", "TypeDefinition")
                        .WithMany()
                        .HasForeignKey("TypeDefinitionNodeId", "TypeDefinitionNodeSetModelUri", "TypeDefinitionNodeSetPublicationDate")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.OwnsMany("Opc.Ua.Cloud.Library.DataTypeModel+StructureField", "StructureFields", b1 =>
                        {
                            ...
                            b1.HasOne("Opc.Ua.Cloud.Library.BaseTypeModel", "DataType")
                                .WithMany()
                                .HasForeignKey("DataTypeNodeId", "DataTypeNodeSetModelUri", "DataTypeNodeSetPublicationDate")
                                .OnDelete(DeleteBehavior.Cascade);
