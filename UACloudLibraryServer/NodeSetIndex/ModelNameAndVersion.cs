...
namespace Opc.Ua.Cloud.Library.NodeSetIndex
{
    ...
    public class ModelNameAndVersion
    {
        ...
        public bool IsNewerOrSame(ModelNameAndVersion thanThis)
        {
            ...
            return NodeSetVersionUtils.IsMatchingOrHigherNodeSet(ModelUri, PublicationDate, ModelVersion, thanThis.PublicationDate, thanThis.ModelVersion) ?? false;
        }
        ...
        public bool HasNameAndVersion(string ofModelUri, DateTime ofPublicationDate, string ofModelVersion)
        {
            ...
            return NodeSetVersionUtils.IsMatchingOrHigherNodeSet(ModelUri, PublicationDate, ModelVersion, ofPublicationDate, ofModelVersion) ?? false;
        }
