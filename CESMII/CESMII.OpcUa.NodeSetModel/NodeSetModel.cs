...
#nullable restore
    ...
    {
        internal BaseTypeModel m_superType;
        public bool IsAbstract { get; set; }
#nullable enable
        public virtual BaseTypeModel? SuperType { get => m_superType; set => m_superType = value; }
#nullable restore
        ...
        {
            System.Diagnostics.Debug.WriteLine($"RemoveInheritedAttributes: Entering function ----------------------------------------");
            while (superTypeModel != null)
            {
                ...
                string strMyType = superTypeModel.GetType().ToString();
                var classtype = typeof(BaseTypeModel);
                var proptype = classtype.GetProperty("SuperType");

                string strMySuperType = proptype.PropertyType.ToString();
                System.Diagnostics.Debug.WriteLine($"RemoveInheritedAttributes: About to dereference for {strMyType} super type:{strMySuperType}");
                if (superTypeModel.SuperType != null)
                {
                    System.Diagnostics.Debug.WriteLine($"RemoveInheritedAttributes: About to dereference for {superTypeModel.Namespace}{superTypeModel.NodeId}.superType");
                }
...
//#nullable enable
//        public override BaseTypeModel? SuperType { get => m_superType; set => m_superType = value; }
//#nullable restore
