...
namespace CESMII.OpcUa.NodeSetModel.Factory.Opc
{
    public interface IOpcUaContext
    {
        ...
        /// 
        /// <returns></returns>
        /// <param name="bSameNamespace"></param>
        string GetModelNodeId(NodeId nodeId, bool bSameNamespace = false);
        ...
        TNodeModel GetModelForNode<TNodeModel>(string nodeId, bool bNewNamespace = false) where TNodeModel : NodeModel;
        ILogger Logger { get; }
